...
<title>Already Logged In画面</title>
</head>
<body>
...
<div class="main-contents">
	...
	<br><br>
		<p class="error-message">すでにログインしています。</p>
		<p class="error-message">ログアウト後、再ログインしてください。</p></div>
		<br><br>

		<div id="text-link">
			<p>ログアウトする場合は<a href='<s:url action="LogoutAction"/>'>こちら</a></p>
			<p>Homeへ戻る場合は<a href='<s:url action="GojomeAction"/>'>こちら</a>
