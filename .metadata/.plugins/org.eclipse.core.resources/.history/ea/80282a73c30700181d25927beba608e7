...
("フルーツロール",150,50,"roll","季節の果物がたくさん入ったケーキです。","./image/roll1.jpg"),
("チョコロール",150,50,"roll","甘さ控えめのロールケーキです。","./image/roll2.jpg"),
("キャラメルロール",150,50,"roll","見た目もかわいいロールケーキです。","./image/roll3.jpg"),
...
("星型クッキー",100,50,"cookie","星型のアイシングクッキーです。","./image/cookie1.jpg"),
("クッキー詰め合わせ",800,50,"cookie","クッキーの詰め合わせです。","./image/cookie2.jpg"),
("アップルクッキー",800,50,"cookie","アップルジャム入りのクッキーです。","./image/cookie3.jpg"),
